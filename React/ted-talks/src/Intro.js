    ...
    <div className="content">
      ...
      <Element name="textContent" className="textContent">
        ...
        <div className="text">
          ...
          <div className="smallTitle">Interesting facts</div>
          ...
          <div>
            ...
            <PieChart width={1200} height={400}>
              <Pie data={popularTopics} cx={250} cy={200} outerRadius={160} fill="#8884d8" label>
                {
                  popularTopics.map((entry, index) => <Cell key={entry} fill={colors[index % colors.length]}/>)
                }
              </Pie>
              <Tooltip/>
            </PieChart>
...
export default shouldUpdate(checkPropsChange)(Intro);